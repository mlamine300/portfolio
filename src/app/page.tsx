...
export default async function Home() {
  ...
  const  {educations,experiences,summary,phone,email,dateOfBirth,education,address,name,skills,heroDescription,finishedProject,clientNumber,yearsOfExperience}=await getPersonalInformation(); 
 

  return (
    <main className="w-full max-md:max-w-screen flex  mb-16 flex-col items-center justify-between p-10 md:p-24">
      <Hero yearsOfExperience={yearsOfExperience} finishedProject={finishedProject} clientNumber={clientNumber}  heroDescription={heroDescription}  />
